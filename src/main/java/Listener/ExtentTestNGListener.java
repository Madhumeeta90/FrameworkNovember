...
public class ExtentTestNGListener implements ITestListener
{
 ...
 public synchronized void onFinish(ITestContext contexxt)
 {
	
	 System.out.println("LOG: INFO _ Report getting generated");
	 extent.flush();
	 System.out.println(" LOG:INFO_ Report Generated");
 }
 ...
 public synchronized void onTestFailure(ITestResult result)
 {
	 ...
	 try {
		...
		Object obj1 = f1.get(result.getInstance());
		
		driver = (WebDriver)obj1;
